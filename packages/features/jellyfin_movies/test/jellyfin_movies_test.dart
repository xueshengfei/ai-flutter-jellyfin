...
void main() {
  ...
  group('MovieFilterPage', () {
    ...
    testWidgets('点击电影触发导航', (WidgetTester tester) async {
      var navigated = false;
      final movies = [
        MediaItem(
            id: 'm1',
      ...
      await tester.pumpWidget(MaterialApp(
        home: ServiceRegistry(
          services: {
            AppNavigator: _FakeAppNavigator(() => navigated = true),
          },
          child: MovieFilterPage(
            libraryId: 'lib1',
            libraryName: '电影库',
            fetchMovies: (_) =>
  ...
  group('MovieDetailPage', () {
    ...
    testWidgets('播放按钮触发导航', (WidgetTester tester) async {
      var navigated = false;
      final movie = MediaItem(
...
class _FakeAppNavigator implements AppNavigator {
  final void Function()? onPushIntent;
