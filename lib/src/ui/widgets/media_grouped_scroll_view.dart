...
class _MediaGroupedScrollViewState<T>
  ...
  String? _filterLetter; // null = 显示全部，非 null = 过滤到该字母
  ...
  void _rebuildGroups() {
    ...
    // 如果当前过滤字母已经没有数据，取消过滤
    if (_filterLetter != null && !_activeLetters.contains(_filterLetter)) {
      _filterLetter = null;
    }
  ...
  List<String> get _displayLetters {
    if (_filterLetter != null) {
      return [_filterLetter!];
    }
    return _grouped.keys.where((l) => _activeLetters.contains(l)).toList();
  }
    ...
    return Stack(children: [
      RefreshIndicator(
        ...
        child: CustomScrollView(
          ...
          slivers: [
                  ...
                  child: Row(
                    children: [
                      Chip(
                        ...
                        onDeleted: () => setState(() => _filterLetter = null),
                        materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
                        visualDensity: VisualDensity.compact,
                      ),
                      const SizedBox(width: 8),
                      Text(
                        '${_grouped[_filterLetter]?.length ?? 0} 项',
            ...
            for (final letter in _displayLetters) ...[
              // 过滤模式下不显示分组头
              if (_filterLetter == null)
                SliverToBoxAdapter(
                  child: Container(
      ...
      Positioned(
        ...
        child: AlphabetIndexBar(
          ...
          availableLetters: _activeLetters,
