...
/// 音乐 App 图片加载实现
final class JellyfinMusicImageProvider implements JellyfinImageProvider {
  final String serverUrl;
  final String accessToken;

  JellyfinMusicImageProvider({
    required this.serverUrl,
    required this.accessToken,
  });

  factory JellyfinMusicImageProvider.fromSession(AppSession session) {
    return JellyfinMusicImageProvider(
